                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
                            ...
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            >
                                                <div className="flex items-center">
                                                    ...
                                                    {!includeDriver && <FaCheck className="ml-auto text-blue-600" />}
                                                </div>
                                            </div>
                                            <div
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative" onClick={() => setShowPickupMap(true)}>
                                            <input
                                                ...
                                                readOnly
                                                className="w-full pr-10 pl-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 cursor-pointer bg-gray-50 hover:bg-gray-100"
                                            />
                                            <FaMapMarkerAlt className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-500" />
                                        </div>
                                    </div>
                                ...
                                <div className="pt-2">
                                    <button
                                        type="submit"
                                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                                    >
