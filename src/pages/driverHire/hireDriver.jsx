...
const HireDriver = () => {
    ...
    const vehicleCategories = ['Sedan', 'SUV', 'Hatchback', 'Luxury', 'Van', 'Mini Truck'];
    ...
    const handleSubmit = (e) => {
        ...
        if (!category.trim()) return toast.error('Please select a vehicle category.');
    ...
    return (
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen flex flex-col">
                ...
                <div className="flex flex-col justify-center">
                    <div className="bg-white p-8 rounded-2xl shadow-lg">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600">Enjoy a stress-free journey with our experienced and verified drivers</p>
                        </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                            <div className="space-y-1">
                                ...
                                <div className="relative" onClick={() => setShowPickupMap(true)}>
                                    <input type="text" value={pickupLocation} placeholder="Enter pickup location" readOnly className="w-full pr-10 pl-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 cursor-pointer bg-gray-50 hover:bg-gray-100" />
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative" onClick={() => setShowDropoffMap(true)}>
                                    <input type="text" value={dropoffLocation} placeholder="Enter drop-off location" readOnly className="w-full pr-10 pl-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 cursor-pointer bg-gray-50 hover:bg-gray-100" />
                                    <FaMapMarkerAlt className="absolute right-3 top-1/2 transform -translate-y-1/2 text-red-500" />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <DatePicker value={pickupDate} onChange={setPickupDate} format="MM/DD/YYYY" minDate={dayjs()} slotProps={{ textField: { fullWidth: true, placeholder: "Select date", sx: { '& .MuiOutlinedInput-root': { borderRadius: '12px', backgroundColor: '#f9fafb', '&.Mui-focused fieldset': { borderColor: '#DC2626' }, } } } }} />
                                </div>
                                <div className="space-y-1">
                                    <label className="block text-sm font-medium text-gray-700">Drop-off Date</label>
                                    <DatePicker value={dropoffDate} onChange={setDropoffDate} format="MM/DD/YYYY" minDate={pickupDate || dayjs()} slotProps={{ textField: { fullWidth: true, placeholder: "Select date", sx: { '& .MuiOutlinedInput-root': { borderRadius: '12px', backgroundColor: '#f9fafb', '&.Mui-focused fieldset': { borderColor: '#DC2626' }, } } } }} />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <TimePicker value={pickupTime} onChange={setPickupTime} slotProps={{ textField: { fullWidth: true, placeholder: "Select time", sx: { '& .MuiOutlinedInput-root': { borderRadius: '12px', backgroundColor: '#f9fafb', '&.Mui-focused fieldset': { borderColor: '#DC2626' }, } } } }} />
                                </div>
                                <div className="space-y-1">
                                    <label className="block text-sm font-medium text-gray-700">Drop-off Time</label>
                                    <TimePicker value={dropoffTime} onChange={setDropoffTime} slotProps={{ textField: { fullWidth: true, placeholder: "Select time", sx: { '& .MuiOutlinedInput-root': { borderRadius: '12px', backgroundColor: '#f9fafb', '&.Mui-focused fieldset': { borderColor: '#DC2626' }, } } } }} />
                                </div>
                            </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                <select value={category} onChange={(e) => setCategory(e.target.value)} className="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 appearance-none bg-gray-50 hover:bg-gray-100 cursor-pointer">
                        ...
                        <div className="pt-2">
                            <button type="submit" className="w-full bg-black hover:bg-gray-800 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">Find Available Drivers</button>
                        </div>
                    </form>
                </div>
            </main>
            ...
            <Footer />
            <ToastContainer position="top-right" autoClose={3000} toastStyle={{ borderRadius: '12px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)' }} progressStyle={{ background: 'rgba(220, 38, 38, 0.7)' }} />
        </div>
    );
};
